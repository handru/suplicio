...
Los datos vistos hasta el momento en el trabajo de tesis (Tabla \ref{tab:tabDataSerial}), son de la ejecución del programa original, las dos subsecciones siguientes mostrarán como evolucionó con la optimización, teniendo como base los tiempos y tamaños obtenidos en esta primer etapa. 
