...
c
     ...
     &       index7,index8,index9,index10,index11,index12,alfac0      
      common npan,nodos,ncapa,npal,npaso,nr,no,np,nk,kult,inic 
c<
c.......................................................................
c
...
c                 
      ...
      call ploteo2
c
      if(index11.eq.0) write(15,19)indice,ncapa
      if(index11.eq.0) write(6,19) indice,ncapa
      if(index11.eq.0) call cargas  
c
c      write(15,16)indice,ncapa
...
c
      ...
      if(index5.ne.0) call circo(nr,no)
c
      if(index5.ne.0) write(6,18) nr,no      
      if(index5.ne.0) call gammas(nr,no)
c
    1 format(2x,'input       (1)',/) 
...
c                             
      do 10 ik=1,kult
c
      write(33,44) ik,re(ir,ik)/rt,ze(ir,ik)/rt,fi(ir,ik),
...
c                             
      do 210 ik=1,kult
c
      write(39,44) ik,re(ir,ik)/rt,ze(ir,ik)/rt,fi(ir,ik),
     &             dista(ik)/rt,denom(ik),1./denom(ik),
     &             dfi*fx(ik)/denom(ik)/ctte,
     &             dfi*fy(ik)/denom(ik)/ctte,
     &             dfi*fz(ik)/denom(ik)/ctte,valx,valy,valz
...
c
      ...
      do 15 l = 1,nb
c      
      read(16,13) rr(k,l),gg(k,l),oo(k,l)
